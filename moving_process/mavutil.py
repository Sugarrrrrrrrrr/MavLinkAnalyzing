...
import select
from moving_process import mavexpression
...
def set_dialect(dialect):
    ...
    import moving_process.generator.mavparse
    if 'MAVLINK20' in os.environ:
        wire_protocol = moving_process.generator.mavparse.PROTOCOL_2_0
        modname = "moving_process.dialects.v20." + dialect
    elif mavlink is None or mavlink.WIRE_PROTOCOL_VERSION == "1.0" or not 'MAVLINK09' in os.environ:
        wire_protocol = moving_process.generator.mavparse.PROTOCOL_1_0
        modname = "moving_process.dialects.v10." + dialect
    else:
        wire_protocol = moving_process.generator.mavparse.PROTOCOL_0_9
        modname = "moving_process.dialects.v09." + dialect

    try:
        mod = __import__(modname)
    except Exception:
        # auto-generate the dialect module
        from moving_process.generator.mavgen import mavgen_python_dialect
