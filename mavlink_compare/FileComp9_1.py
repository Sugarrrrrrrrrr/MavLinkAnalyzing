...
def _to(n, uav_ip, groundstation_ip):
    df = DebugFile('data/_debug%d' % n, uav_ip, groundstation_ip)
...
def _from(n, uav_ip, groundstation_ip):
    df = DebugFile('data/_debug%d' % n, uav_ip, groundstation_ip)
    wf = WireSharkFile('data/_Wireshark%d' % n, uav_ip, groundstation_ip)
...
def main():
    ...
    n_to, to_lost_list = _to(n, uav_ip, groundstation_ip)
    n_from, from_lost_list = _from(n, uav_ip, groundstation_ip)
